...
public interface GroupDao {
     ...
     */
    @Insert("INSERT INTO `platformDB`.`group_tbl` (`group_name`," +
            " `group_account`," +
            ...
            " `group_background`," +
            " `group_signature`) " +
            "VALUES (#{groupBean.group_name}" +
            ", #{groupBean.group_account}" +
            ", #{groupBean.group_creator_account}" +
            ", #{groupBean.group_create_time}," +
            " #{groupBean.group_sizes}," +
            " #{groupBean.group_max_sizes}," +
            " #{groupBean.group_headshot}," +
            " #{groupBean.group_background}," +
            " #{groupBean.group_signature})")
    int insertUser(@Param("groupBean") GroupBean groupBean);
